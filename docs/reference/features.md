...
19 российских модулей · 148 инструментов · 54 ресурса · 38 промптов
...
### `cekrf` — Центральная избирательная комиссия РФ (9 tools, 4 resources, 2 prompts)

Выборы, кандидаты, партии, результаты, явка.
...
**Resources:** `data://tipy-vyborov`, `data://subyekty-rf`, `data://partii-rf`, `data://info-api`
...
Нормативные акты, законопроекты, поиск, официальные публикации pravo.gov.ru.
...
### `fssp` — Федеральная служба судебных приставов (9 tools, 3 resources, 2 prompts)

Исполнительные производства, ограничения, розыск должников.
...
Транспортные средства, водительские удостоверения, штрафы, ДТП.
