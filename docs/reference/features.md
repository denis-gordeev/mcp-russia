...
22 российских модуля · 181 инструмент · 65 ресурсов · 44 промпта
...
### `rosstat` — Федеральная служба государственной статистики (10 tools, 2 resources, 2 prompts)

Демография, экономика, региональная статистика, федеральные округа, ВРП, заработная плата. Реальные API: fedstat.ru (ЕМИСС). 93 субъекта РФ. 21 код показателя ЕМИСС.
