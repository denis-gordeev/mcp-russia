...
24 российских модуля · 212 инструментов · 70 ресурсов · 48 промптов
...
> **Статус миграции:** сервер полностью перешёл на российские реалии. 24 российских модуля данных подключены к реальным API. Legacy-модули с бразильскими данными удалены из кодовой базы.
...
| `golosovaniya` | Голосования Госдумы с фильтрацией по созыву |
...
| `poisk_kontraktov` | Поиск контрактов по параметрам |
...
### `fssp` — Федеральная служба судебных приставов (9 инструментов, 3 ресурса, 2 промпта)
