...
22 российских модуля · 182 инструмента · 65 ресурсов · 44 промпта
...
### `rosstat` — Федеральная служба государственной статистики (11 tools, 2 resources, 2 prompts)

Демография, экономика, региональная статистика, федеральные округа, ВРП, заработная плата, региональное сравнение, универсальный запрос по коду ЕМИСС. Реальные API: fedstat.ru (ЕМИСС). 92 субъекта РФ. 21 код показателя ЕМИСС.
...
| `pokazateli_rosstata` | Справочник основных показателей Росстата (16 показателей) |
