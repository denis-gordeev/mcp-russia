...
23 российских модуля · 193 инструмента · 68 ресурсов · 46 промптов
...
> **Статус миграции:** сервер полностью перешёл на российские реалии. 23 российских модуля данных подключены к реальным API. Legacy-модули с бразильскими данными удалены из кодовой базы.
