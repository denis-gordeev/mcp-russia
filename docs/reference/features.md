...
27 модулей · 256 инструментов · 87 ресурсов · 59 промптов
...
### `rosstat` — Федеральная служба государственной статистики (21 инструмент, 2 ресурса, 2 промпта)

Демография, экономика, региональная статистика, федеральные округа, ВВП, ВРП, заработная плата, безработица, доходы, промышленность, бедность, пенсии, отраслевая структура ВРП по ОКВЭД 2, инвестиции по видам деятельности, региональное и окружное сравнение, универсальный запрос по коду ЕМИСС. Реальные API: fedstat.ru (ЕМИСС). 92 субъекта РФ. 27 кодов показателей ЕМИСС (обновлены после перехода на ОКВЭД 2).
...
| `sravnenie_okrugov` | Рейтинг и сравнение федеральных округов по выбранному показателю |
