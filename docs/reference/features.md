...
27 модулей · 250 инструментов · 87 ресурсов · 59 промптов
...
### `rosstat` — Федеральная служба государственной статистики (15 инструментов, 2 ресурса, 2 промпта)

Демография, экономика, региональная статистика, федеральные округа, ВРП, заработная плата, отраслевая структура ВРП по ОКВЭД 2, инвестиции по видам деятельности, региональное и окружное сравнение, универсальный запрос по коду ЕМИСС. Реальные API: fedstat.ru (ЕМИСС). 92 субъекта РФ. 27 кодов показателей ЕМИСС (обновлены после перехода на ОКВЭД 2).
