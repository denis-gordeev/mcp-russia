...
24 российских модуля · 202 инструмента · 71 ресурс · 48 промптов
...
| `info_regiona` | Детальная информация о регионе: население, ВРП, средняя зарплата (ЕМИСС) |
| `info_okruga` | Информация о федеральном округе с перечнем субъектов |
