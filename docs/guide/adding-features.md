...
Этот гид описывает текущее состояние `mcp-russia`: новые модули нужно добавлять напрямую в `src/mcp_russia/`, потому что auto-discovery уже смотрит в актуальный namespace проекта.
