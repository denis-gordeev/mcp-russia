...
Этот гид описывает текущее состояние `mcp-russia`: новые модули нужно добавлять напрямую в `src/mcp_russia/`, потому что автообнаружение уже смотрит в актуальное пространство имён проекта.
...
- Текущее место добавления модулей: `src/mcp_russia/...`.
