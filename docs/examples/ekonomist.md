...
> Prompt: "Собери краткий макрообзор по России: курсы валют, инфляция и региональные различия"
...
> Prompt: "Сравни курсы основных валют по данным ЦБ РФ"
...
> Prompt: "Покажи курс доллара и конвертируй 10 000 долларов в рубли"
...
> Prompt: "Собери краткий бюджетный профиль: закупки, контракты и расходы"
