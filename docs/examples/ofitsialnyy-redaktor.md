...
> Как использовать агент «Делопроизводство» в `mcp-russia` для подготовки официальных документов с опорой на реальные данные публичных API.
...
3. **Собирает текст** по правилам российского делопроизводства
