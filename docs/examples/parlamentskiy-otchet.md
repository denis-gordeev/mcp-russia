...
В текущем состоянии репозитория такой отчёт стоит понимать как публичный рабочий процесс `mcp-russia` над набором парламентских и избирательных интеграций. Реализованные модули (`gosduma`, `cekrf`, `zakupki`, `kad_arbitrazh`, `sovfed`, `kaznacheistvo`) полностью функциональны; инструменты, отмеченные как «инструмент недоступен», будут добавлены в будущих модулях.
