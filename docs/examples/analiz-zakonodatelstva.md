...
- `sovfed_poisk_zakonoproektov(...)` *(подробности, докладчик, комитет — планируемый параметр)* — докладчик, комитет
- `sovfed_poisk_zakonoproektov(...)` *(поправки — планируемый инструмент)* — внесённые поправки
- `sovfed_poisk_zakonoproektov(...)` *(ход рассмотрения — планируемый инструмент)* — история в Совете Федерации
...
Инструменты:
- `sovfed_spisok_zasedaniy` *(поимённое голосование — планируемый инструмент)* — результат
- `sovfed_spisok_zasedaniy` *(подробности голосования — планируемый инструмент)* — именной голос
...
Инструменты:
- `publikatsii_poisk_aktov(tekst="искусственный интеллект", tip="закон")`
...
Инструменты:
- `kad_arbitrazh_poisk_del(kategoriya="искусственный интеллект")`
- `kad_arbitrazh_poisk_del(istorcz="искусственный интеллект регулирование")`
...
Инструменты:
- `kad_arbitrazh_poisk_del(kategoriya="регулирование технологий")`
- `kad_arbitrazh_poisk_del(kategoriya="искусственный интеллект ответственность")`
...
- `sovfed_poisk_zakonoproektov(...)` *(текст законопроекта — планируемый инструмент)* — текст Совета Федерации
- `sovfed_poisk_zakonoproektov(...)` *(поправки — планируемый инструмент)* — поправки, изменившие текст
...
- `sovfed_spisok_zasedaniy` *(история аналогичных голосований — планируемый инструмент)*
...
Этап 2 — Детализация (параллельно):
  ...
  ├── gosduma_zakonoproekty(sostoyanie="...")
  ├── sovfed_poisk_zakonoproektov(...)*(подробности — планируемый инструмент)*
  └── sovfed_poisk_zakonoproektov(...)*(ход рассмотрения — планируемый инструмент)*

Этап 3 — Голосования (параллельно):
  ├── gosduma_golosovaniya(sozyv=..., ogranichenie=...)
  └── sovfed_spisok_zasedaniy *(голосование — планируемый инструмент)*
...
Этап 5 — Судебная часть:
  ├── kad_arbitrazh_poisk_del(kategoriya="ФЗ 12345")
  └── kad_arbitrazh_poisk_del(kategoriya="искусственный интеллект")

Этап 6 — Публикация:
  └── publikatsii_poisk_aktov(tekst="ФЗ [номер]")
```
