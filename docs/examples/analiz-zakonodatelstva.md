...
_Примечание: Значения и сценарии иллюстративны и демонстрируют возможности `mcp-russia`. Используйте tools для получения актуальных данных. Инструменты, отмеченные как «планируемый», находятся в разработке._
