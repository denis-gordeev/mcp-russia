...
from mcp_russia.data.tce_pe.schemas import UnidadeJurisdicionada
from mcp_russia.data.tce_pe.server import mcp

CLIENT_MODULE = "mcp_russia.data.tce_pe.client"
