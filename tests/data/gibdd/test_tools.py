...
from mcp_brasil.data.gibdd import tools as gibdd_tools
...
async def test_spisok_tipov_ts():
    ...
    assert "легковой" in result.lower() or "Легковой" in result
