...
from mcp_russia.data.tce_sc import tools
from mcp_russia.data.tce_sc.schemas import Municipio, UnidadeGestora

CLIENT_MODULE = "mcp_russia.data.tce_sc.client"
