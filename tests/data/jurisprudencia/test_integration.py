...
from mcp_russia.data.jurisprudencia.schemas import Jurisprudencia
from mcp_russia.data.jurisprudencia.server import mcp

CLIENT_MODULE = "mcp_russia.data.jurisprudencia.client"
