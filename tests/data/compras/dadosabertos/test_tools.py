...
from mcp_russia.data.compras.dadosabertos import tools
from mcp_russia.data.compras.dadosabertos.schemas import (
    ContratoDA,
    ContratoDAResultado,
    FornecedorDA,
...
CLIENT_MODULE = "mcp_russia.data.compras.dadosabertos.client"
