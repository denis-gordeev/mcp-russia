...
.. deprecated::
    Используйте модуль ``mcp_brasil.data.zakupki`` (ЕИС — zakupki.gov.ru) для российских госзакупок.
...
FEATURE_META = FeatureMeta(
    ...
    requires_auth=False,
    tags=["⚠️ DEPRECATED", "тендеры", "контракты", "закупки", "pncp", "поставщики", "catmat", "catser", "бразилия-legacy"],
)
