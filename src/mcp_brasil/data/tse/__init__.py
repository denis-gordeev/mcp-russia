...
.. deprecated::
    Используйте модуль ``mcp_brasil.data.cekrf`` (ЦИК РФ — vybory.izbirkom.ru)
...
FEATURE_META = FeatureMeta(
    ...
    requires_auth=False,
    tags=["⚠️ DEPRECATED", "избирательный", "кандидаты", "выборы", "tse", "отчёты-о-расходах", "бразилия-legacy"],
)
