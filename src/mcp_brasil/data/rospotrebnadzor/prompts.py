"""Prompts for the Роспотребнадзор feature.

All prompts are in Russian with "(legacy)" markers since this is
a placeholder module pending real API integration.
"""
...
def analiz_proverki() -> PromptResult:
    """Анализ результатов проверки. (legacy — placeholder)
...
def obzor_sanitarnoy_situacii() -> PromptResult:
    """Обзор санитарно-эпидемиологической ситуации в регионе. (legacy — placeholder)
