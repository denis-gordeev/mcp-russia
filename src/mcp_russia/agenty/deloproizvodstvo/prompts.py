"""Промпты: агенты по типам документов.
...
def redaktor_pismo(
    ...
    return [
        Message(
            ...
            f"1. Загрузи шаблон письма (resource shablon://pismo)\n"
            f"2. Загрузи нормы делопроизводства (resource normy://manual)\n"
            f"3. Используй konsultirovat_obrashchenie() для правильной формы обращения\n"
...
def redaktor_prikaz(
    ...
    return [
        Message(
            ...
            f"Инструкции:\n"
            f"1. Загрузи шаблон приказа (resource shablon://prikaz)\n"
...
def redaktor_rasporyazhenie(
    ...
    return [
        Message(
            ...
            f"Основание: {osnovanie if osnovanie else '[указать основание]'}\n\n"
            f"Инструкции:\n"
            f"1. Загрузи шаблон (resource shablon://rasporyazhenie)\n"
...
def redaktor_akt(tema: str, komissiya: str = "") -> list[Message]:
    ...
    return [
        Message(
            ...
            f"Инструкции:\n"
            f"1. Загрузи шаблон акта (resource shablon://akt)\n"
...
def redaktor_spravka(tema: str, dannye: str = "") -> list[Message]:
    ...
    return [
        Message(
            ...
            f"Инструкции:\n"
            f"1. Загрузи шаблон справки (resource shablon://spravka)\n"
...
def redaktor_protokol(
    ...
    return [
        Message(
            ...
            f"Инструкции:\n"
            f"1. Загрузи шаблон (resource shablon://protokol)\n"
...
def redaktor_dokladnaya_zapiska(
    ...
    return [
        Message(
            ...
            f"Инструкции:\n"
            f"1. Загрузи шаблон (resource shablon://dokladnaya_zapiska)\n"
