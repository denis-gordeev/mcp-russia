...
Каждый промпт — «виртуальный агент», который инструктирует LLM:
...
def redaktor_pismo(
    ...
    return [
        Message(
            ...
            f"1. Загрузи шаблон письма (ресурс shablon://pismo)\n"
            f"2. Загрузи нормы делопроизводства (ресурс normy://manual)\n"
...
def redaktor_prikaz(
    ...
    return [
        Message(
            ...
            f"Инструкции:\n"
            f"1. Загрузи шаблон приказа (ресурс shablon://prikaz)\n"
...
def redaktor_rasporyazhenie(
    ...
    return [
        Message(
            ...
            f"Основание: {osnovanie if osnovanie else '[указать основание]'}\n\n"
            f"Инструкции:\n"
            f"1. Загрузи шаблон (ресурс shablon://rasporyazhenie)\n"
...
def redaktor_akt(tema: str, komissiya: str = "") -> list[Message]:
    ...
    return [
        Message(
            ...
            f"Инструкции:\n"
            f"1. Загрузи шаблон акта (ресурс shablon://akt)\n"
...
def redaktor_spravka(tema: str, dannye: str = "") -> list[Message]:
    ...
    return [
        Message(
            ...
            f"Инструкции:\n"
            f"1. Загрузи шаблон справки (ресурс shablon://spravka)\n"
...
def redaktor_protokol(
    ...
    return [
        Message(
            ...
            f"Инструкции:\n"
            f"1. Загрузи шаблон (ресурс shablon://protokol)\n"
...
def redaktor_dokladnaya_zapiska(
    ...
    return [
        Message(
            ...
            f"Инструкции:\n"
            f"1. Загрузи шаблон (ресурс shablon://dokladnaya_zapiska)\n"
