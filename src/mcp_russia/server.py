...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "26 модулей данных подключены к реальным российским API: ЦБ РФ, Росгидромет, ФНС, "
        "Госдума, Закупки, КАД Арбитраж, РосАПИ, Росреестр, ГИБДД, ЦИК РФ, ФССП, "
        "Официальные публикации, Минобрнауки, Роспотребнадзор, Роскомнадзор, Росстат, "
        "Росводресурсы, Минздрав, Счётная палата, Совет Федерации, Казначейство, "
