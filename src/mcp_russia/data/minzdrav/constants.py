...
# Федеральные округа
FEDERALNYE_OKRUGA = [
    {"kod": "CFD", "nazvanie": "Центральный федеральный округ"},
    {"kod": "SZFD", "nazvanie": "Северо-Западный федеральный округ"},
    {"kod": "YuFD", "nazvanie": "Южный федеральный округ"},
    {"kod": "SKFD", "nazvanie": "Северо-Кавказский федеральный округ"},
    {"kod": "PFD", "nazvanie": "Приволжский федеральный округ"},
    {"kod": "UFD", "nazvanie": "Уральский федеральный округ"},
    {"kod": "SFD", "nazvanie": "Сибирский федеральный округ"},
    {"kod": "DFD", "nazvanie": "Дальневосточный федеральный округ"},
]

# Виды лицензируемой деятельности
VIDY_LITSENZIRUEMOY_DEYATELNOSTI = [
    {"kod": "med", "nazvanie": "Медицинская деятельность"},
    {"kod": "pharma", "nazvanie": "Фармацевтическая деятельность"},
    {"kod": "radio", "nazvanie": "Деятельность, связанная с источниками ионизирующего излучения"},
]
