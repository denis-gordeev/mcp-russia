...
REGIONALNYE_UPRAVLENIYA = [
    {"kod": "ЦФО", "nazvanie": "Управление по Центральному федеральному округу"},
    {"kod": "СЗФО", "nazvanie": "Управление по Северо-Западному федеральному округу"},
    {"kod": "ЮФО", "nazvanie": "Управление по Южному федеральному округу"},
    {"kod": "СКФО", "nazvanie": "Управление по Северо-Кавказскому федеральному округу"},
    {"kod": "ПФО", "nazvanie": "Управление по Приволжскому федеральному округу"},
    {"kod": "УФО", "nazvanie": "Управление по Уральскому федеральному округу"},
    {"kod": "СФО", "nazvanie": "Управление по Сибирскому федеральному округу"},
    {"kod": "ДФО", "nazvanie": "Управление по Дальневосточному федеральному округу"},
]
