...
- Клиент Госдумы проходит строгую типизацию и устойчив к `null`, отсутствующим полям, числовым строкам и неожиданным контейнерам во внешних ответах; это покрыто отдельными клиентскими тестами.
...
- погасить оставшиеся 127 ошибок строгой типизации в 18 файлах клиентов внешних API и восстановить прохождение общего `mypy`;
...
- генерировать справочник инструментов из MCP-реестра вместо ручного ведения счётчиков;
