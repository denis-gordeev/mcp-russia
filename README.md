...
- автоматически сверять имена инструментов и параметры в промптах и примерах с MCP-реестром;
- синхронизировать форматирование клиентских модулей с текущей версией Ruff, чтобы `make ci` снова проходил целиком;
- погасить накопленный долг строгой типизации в клиентах внешних API и восстановить прохождение `mypy`;
- консолидировать исторические отчёты из `TODO.md` в отдельный архив, оставив в плане актуальные задачи.
